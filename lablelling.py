...
class DraggableGraphicsView(QGraphicsView):
    ...
    # def LoadRectItem(self, labels, image_w, image_h) :
    #     xywh = []
    #     for _ in range(len(labels)) :
    #         xywh.append(YOLOImageOriginBoundingBox(labels[_][1:5], image_w, image_h))

    #     for rect_data in xywh:
    ...
    def SaveRectItem(self,path) :
        if self.rect_items is not None :
            ...
            with open(path,'w') as file :
                for rect_item in rect_items_copy :
                    rect = rect_item.rect()
                    x = rect.x()
                    y = rect.y()
                    width = rect.width()
                    ...
                    file.write(f"{self.clss} {x} {y} {width} {height} \n")
    ...
    def LabelLoader(self, path) :
        self.path = path
    
    def setImage(self, pixmap):
        self.rect_items = []
        self.scene().clear()
        item = QGraphicsPixmapItem(pixmap.scaled(1792, 1536, Qt.AspectRatioMode.KeepAspectRatio))
...
class Ui_Dialog(QMainWindow):
    ...
    def setupUi(self, Dialog):
        ...
        self.toglebtn.setGeometry(QtCore.QRect(400, 10, 200, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_6.setText(_translate("Dialog", "clearRectItems"))
    ...
    def save_clicked(self) :
        ...
        if self.clss >= 0 :
            ...
            path = f"{self.root_path}/label/{self.file_name[:-4]}.txt"
            self.label.SaveRectItem(path)
            self.next_clicked()
