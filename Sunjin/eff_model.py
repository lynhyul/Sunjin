...
md = ModelCheckpoint("e:/test.h5",monitor='val_loss',verbose=1,save_best_only=True)

# idg = ImageDataGenerator(validation_split=0.2)
idg = ImageDataGenerator(validation_split=0.2,rotation_range=90,zoom_range=0.1,shear_range=0.1)
idg2 = ImageDataGenerator(validation_split=0.2)
